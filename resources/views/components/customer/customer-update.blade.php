...
<script>
    ...
    async function FillUpUpdateForm(id){
        ...
        document.getElementById('customerPhoneUpdate').value=res.data['mobile'];
    }
    ...
    async function Update() {
        ...
        if (customerName.length === 0) {
            ...
            let res = await axios.post("/update-customer",{name:customerName,email:customerEmail,phone:customerPhone,id:updateID})
