                    ...
                    <div class="container">
                        <div class="row">
                            <div class="col-12 p-1">
                                ...
                                <input type="text" class="form-control" id="productNameUpdate" placeholder="Product Name">

                                <label class="form-label mt-2">Price</label>
                                <input type="text" class="form-control" id="productPriceUpdate" placeholder="Product Price">

                                <label class="form-label mt-2">Unit</label>
                                <input type="text" class="form-control" id="productUnitUpdate" placeholder="Product Unit">
                                <br/>
...
<script>
    ...
    async function update() {
        try {
            ...
            if (productCategoryUpdate.length === 0 || productNameUpdate.length === 0 || productPriceUpdate.length === 0 || productUnitUpdate.length === 0) {
            ...
            if (res.status === 200) {
                ...
                errorToast("Failed to update producvt.");
            }
        } catch (error) {
            hideLoader();
